...
class TwoTokens:
    def __init__(self, split_line, reading_gold_file=False):
        ...
        self.sent_offset_e1 = split_line[1]
        self.begin_token_e1 = split_line[2]
        self.end_token_e1 = split_line[3]
        self.entity_type1 = split_line[4]
        self.e1_identifier = split_line[5]
        self.token1 = split_line[6]
        self.sent_offset_e2 = split_line[7]
        self.begin_token_e2 = split_line[8]
        self.end_token_e2 = split_line[9]
        self.entity_type2 = split_line[10]
        self.e2_identifier = split_line[11]
